    ...
    <div class="container-fluid">
				...
				<div class="card">
					...
					<div class="body">
						<div class="btn-group top-head-btn">
                            <a class="btn-primary" href="{{ url('admin/store/add') }}">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> Store List</h2>
					</div>
                    <div class="body">
                        <div class="table-">
                                        ...
                                        <table class="table table-hover js-basic-example contact_list dataTable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="center sorting" tabindex="0"
                                                        ...
                                                        aria-label=" Mobile : activate to sort column ascending"> Domain
                                                    </th>
                                                    <th class="center sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
													...
													@foreach($result as $key=>$value)
														<tr class="gradeX odd">
															...
															<td class="center">
																...
																<a href="{{ route('admin.store.update', ['id' => $value->id] )}}" title="Update Store" class="btn btn-tbl-edit">
																	<i class="fas fa-pencil-alt"></i>
																</a>
																<a title="Delete Store" onclick="return confirm('Are you sure? You want to delete this user.')" href="{{ route('admin.store.delete', ['id' => $value->id] )}}" class="btn btn-tbl-delete">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="center" rowspan="1" colspan="1"> Domain </th>
